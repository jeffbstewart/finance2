...
(decide at Phase 6, no need now): render an Omega glyph from an OFL-licensed
...
| **Tiingo** | Silent; community wrappers commonplace | OK - "internal consumption only" (sec. 7.3) covers a private DB; redistribution needs a paid license | "Data sourced by Tiingo" attribution applies only if a redistribution license is ever obtained |
